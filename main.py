...
from commands.list import subparser_install as list_subparser
from commands.rename import subparser_install as rename_subparser
from commands.test import subparser_install as test_subparser
from commands.random import subparser_install as random_subparser
...
async def on_event(message):
    ...
    client.server = list(client.guilds)[0]
    await react(message)
